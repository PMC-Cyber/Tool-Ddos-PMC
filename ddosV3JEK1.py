...
banner = f"""\n
{Fore.YELLOW}      (●) (●)
{Fore.YELLOW} [ {Fore.RED}TUPAI ATACKER {Fore.YELLOW}]
{Fore.WHITE}Author : Mr./B7
{Fore.WHITE}Github : https://github.com/Unlimitid-Crak-You

{Fore.RED}┏┳┓ ┳ ┳ ┏━┓ ┏━┓ ┳   ┏━┓ ┏┳┓ ┏┳┓ ┏━┓ ┏━┓ ┳┏━  
{Fore.LIGHTRED_EX} ┃  ┃ ┃ ┣━┛ ┣━┫ ┃   ┣━┫  ┃   ┃  ┣━┫ ┃   ┣┻┓ 
{Fore.WHITE} ┻  ┗━┛ ┻   ┻ ┻ ┻   ┻ ┻  ┻   ┻  ┻ ┻ ┗━┛ ┻ ┻  {Fore.YELLOW}(PMC) {Fore.LIGHTYELLOW_EX}TPA V1{Fore.RESET}\n"""

print(banner)
host = ""
ip = ""
target_loader = input(f"{Fore.LIGHTYELLOW_EX}\033[31m[ \033[37mWARNING \033[31m] \033[32mMASUKAN DOMAIN WEBSITE TARGET KALIAN !!\n• \033[33mINPUT \033[37m>> \033[36mIP/URL : \033[33m")
...
booter_sent = int(input(F"{Fore.GREEN}• \033[33mINPUT \033[37m>> \033[36mBOOTER SENT ( DEFAULT=500 ) : \033[33m"))
...
methods_loader = input(F"{Fore.LIGHTBLUE_EX}\n• \033[33mINPUT \033[37m>> \033[36mHTTP_METHODS (EXAMPLE=GATEWAY) : \033[33m")
