...
def logo():
 print(bcolors.OKGREEN + '   ╔╦╗ ╔╦╗ \033[37m╔═╗ ╔═╗   \033[37m╦ ╔╗╔  ╦ ╔═╗ ╦╔═ ╔═╗ ╦')
 print(bcolors.OKGREEN + '    ║║  ║║ \033[37m║ ║ ╚═╗   \033[37m║ ║║║  ║ ║╣  ╠╩╗ ╚═╗ ║')
 print(bcolors.OKGREEN + '   ═╩╝ ═╩╝ \033[37m╚═╝ ╚═╝   \033[37m╩ ╝╚╝ ╚╝ ╚═╝ ╩┈╩ ╚═╝ ╩')
 print(bcolors.OKGREEN + '                    Version : '+version)
 print('')
 print(bcolors.WARNING + '\033[37mAuthor  : \033[36mMr./B7')
 print(bcolors.WARNING + '\033[37mGithub  : \033[36mhttps://github.com/Unlimitid-Crak-You')
 print(bcolors.WARNING + '\033[37mVersion : \033[36m'+version)
 print('')
 print(bcolors.WARNING + '\033[31m[ \033[37mWARNING \033[31m] \033[32mMASUKAN DOMAIN WEBSITE TARGET KALIAN !!\n\n\n')
...
def main(proxy, url):
	...
	logo()
	if url == None:
		print(bcolors.LITBU + "\033[37mENTER THE FULL URL :\n\033[37mexample : \033[36mhttps://google.com\n")
		url = input(bcolors.LITBU + "\033[36m >> \033[37mURL site : \033[36m")
	if url[:4] != "http":
